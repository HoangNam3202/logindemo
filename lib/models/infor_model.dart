...
//
//     final inforModel = inforModelFromJson(jsonString);

import 'dart:convert';

InforModel inforModelFromJson(String str) =>
    InforModel.fromJson(json.decode(str));

String inforModelToJson(InforModel data) => json.encode(data.toJson());
...
class InforModel {
  ...
  factory InforModel.fromJson(Map<String, dynamic> json) => InforModel(
        id: json["id"],
